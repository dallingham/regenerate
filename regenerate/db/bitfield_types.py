...
TYPES = (
    ...
    BitFieldInfo(
        ...
        "Read/Write, Read only on control signal, "
        "one shot on any valid write", "RW"
    ),
    BitFieldInfo(
        BitField.TYPE_WRITE_1_TO_CLEAR_SET_CLR,
