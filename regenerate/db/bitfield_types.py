...
TYPES =  (
    ...
    (BitField.TYPE_WRITE_1_TO_SET,            "W1S",     True,  False, False, False, True,  False, False, "Write 1 to Set, clear on input signal"),
    (BitField.TYPE_WRITE_1_TO_SET_1S,         "W1S1S",   True,  False, True,  False, True,  False, False, "Write 1 to Set, one shot on any write, clear on input signal"),
    (BitField.TYPE_WRITE_1_TO_SET_1S1,        "W1S1S1",  True,  False, True,  False, True,  False, False, "Write 1 to Set, one shot on write of 1, clear on input signal"),
