...
TYPES = (
    ...
    BitFieldInfo(
        ...
        read=False,
        readonly=False,
        description="Read/Write, bits reset to default on input signal",
        simple_type="RW",
    ),
    BitFieldInfo(
    ...
    BitFieldInfo(
        type=BitType.WRITE_ONLY_WITH_DATA_1S,
        id="WOD",
        input=False,
        control=False,
        oneshot=True,
        ...
        read=False,
        readonly=False,
        description="Write Only with data, one shot on a write",
        simple_type="WO",
    ),
    BitFieldInfo(
    ...
    BitFieldInfo(
        type=BitType.READ_WRITE_PROTECT_RESET_1S,
        id="RWPR1S",
        input=False,
        control=True,
        oneshot=True,
        ...
        read=False,
        readonly=False,
        description="Read/Write, Read only if control is high, reset when control is released, one shot on any valid write",
        simple_type="RW",
    ),
    BitFieldInfo(
        type=BitType.READ_WRITE_PROTECT_ILLEGAL_1S,
        id="RWPRI1S",
        input=False,
        control=True,
        oneshot=True,
        ...
        read=False,
        readonly=False,
        description="Read/Write, Read only on control signal, one shot on protection violation",
        simple_type="RW",
    ),
    BitFieldInfo(
